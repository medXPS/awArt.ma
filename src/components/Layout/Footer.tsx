        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Discover unique handcrafted and digital artworks from talented artists around the world. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/artworks" className="text-gray-400 hover:text-emerald-400 transition-colors">Browse Art</a></li>
              <li><a href="/artists" className="text-gray-400 hover:text-emerald-400 transition-colors">Our Artists</a></li>
