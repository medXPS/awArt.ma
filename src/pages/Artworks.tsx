              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="ml-2 text-sm text-gray-700">{t('allCategories')}</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="text-emerald-600 focus:ring-emerald-500"
                    />
                    <span className="ml-2 text-sm text-gray-700">{t('physical')}</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="text-emerald-600 focus:ring-emerald-500"
                    />
                    <span className="ml-2 text-sm text-gray-700">{t('digital')}</span>
                  </label>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center border border-gray-300 rounded-lg">
                  <button
                    ...
                    className={`p-2 ${viewMode === 'grid' ? 'bg-emerald-100 text-emerald-600' : 'text-gray-600'} hover:bg-gray-50 transition-colors rounded-l-lg`}
                  >
                    <Grid className="h-4 w-4" />
                  </button>
                  <button
                    onClick={() => setViewMode('list')}
                    className={`p-2 ${viewMode === 'list' ? 'bg-emerald-100 text-emerald-600' : 'text-gray-600'} hover:bg-gray-50 transition-colors rounded-r-lg`}
                  >
